...
//	strContent = strContent + "<object style=\"visibility: hidden;\" id=\"MediaPlayer\" width=\"2\" height=\"2\" data=\"\\static\\sounds\\click.wav\" type=\"audio//x-wav\"></object>";
...
//	var intY = Math.floor(intMS/31536E6);
//	if (intY > 0){
//		var d1 = new Date();
//		var d2 = new Date();
//		d1 = objNow.valueOf();
...
//			}
//		}
//		correction = leapCount * 864E5;
//	}
//	intMS = intMS - (intY*31536E6);// - correction;
	...
	var strTmp = /*CD_F(intY, "y", objW) + */CD_F(intD, "d", objW) + CD_F(intH, "h", objW) + CD_F(intM, "m", objW) + CD_F(intS, "s", objW);
...
function CD_F(intData, strPrefix, objW) {
	...
	if (intData.toString().length < intMinDigits) {
		for (var a = 0; a < (intMinDigits - intData.toString().length); a++){
			strBlank += objW[strPrefix + "_img"] + "0" + objW[strPrefix + "_imgend"];
		}
//		strResult = "0000000000" + strResult;
//		strResult = strResult.substring(strResult.length, strResult.length - intMinDigits);
	}
	var strTemp = strResult;
	strResult = "";
	for (var x = 0; x <= strTemp.length; x++){
		if (x == 0){
			strResult = strBlank;
		}
		if ((strTemp.substr(x, 1)!= "") && (strTemp.substr(x, 1)!= "-")){
			strResult += objW[strPrefix + "_img"] + strTemp.substr(x, 1) + objW[strPrefix + "_imgend"];
		}
	}
		...
		for (var i=1; objElem; ++i) {
			...
			if (objElem && (typeof objElem.innerHTML) != 'undefined') {
				...
				if (!isNaN(objDate)) {
					...
					objW.servertime		= "";
					//objW.y_mindigits	= 0;
					//objW.y_unit			= "<img class=\"l\" src=\\static\\images\\lYear.png>";
					//objW.y_units		= "<img class=\"l\" src=\\static\\images\\lYears.png>";
					//objW.y_before		= "";
					//objW.y_after		= "";
					//objW.y_hidezero		= 1;
					//objW.y_img			= "<img class=\"y\" src=\\static\\images\\";
					//objW.y_imgend		= ".png>";
					objW.d_mindigits	= 2;
					objW.d_unit			= "<img class=\"l\" src=\\static\\images\\lDay.png>";
					objW.d_units		= "<img class=\"l\" src=\\static\\images\\lDays.png>";
					objW.d_before		= "";
					objW.d_after		= "";
					objW.d_hidezero		= 0;
					objW.d_img			= "<img class=\"d\" src=\\static\\images\\";
					objW.d_imgend		= ".png>";
					objW.h_mindigits	= 2;
					objW.h_unit			= "<img class=\"l\" src=\\static\\images\\lHour.png>";
					objW.h_units		= "<img class=\"l\" src=\\static\\images\\lHours.png>";
					objW.h_before		= "";
					objW.h_after		= "";
					objW.h_hidezero		= 0;
					objW.h_img			= "<img class=\"h\" src=\\static\\images\\";
					objW.h_imgend		= ".png>";
					objW.m_mindigits	= 2;
					objW.m_unit			= "<img class=\"l\" src=\\static\\images\\lMinute.png>";
					objW.m_units		= "<img class=\"l\" src=\\static\\images\\lMinutes.png>";
					objW.m_before		= "";
					objW.m_after		= "";
					objW.m_hidezero		= 0;
					objW.m_img			= "<img class=\"m\" src=\\static\\images\\";
					objW.m_imgend		= ".png>";
					objW.s_mindigits	= 2;
					objW.s_unit			= "<img class=\"l\" src=\\static\\images\\lSecond.png>";
					objW.s_units		= "<img class=\"l\" src=\\static\\images\\lSeconds.png>";
					objW.s_before		= "";
					objW.s_after		= "";
					objW.s_hidezero		= 0;
					objW.s_img			= "<img class=\"s\" src=\\static\\images\\";
					objW.s_imgend		= ".png>";
					objW.event_msg		= "";
